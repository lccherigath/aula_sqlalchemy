...
class Filme(Base):
    ...
    atores = relationship('Ator', secondary='filme_ator', backref='filmes')
...
class Contato(Base):
    ...
    ator = relationship('Ator', backref='contatos')

    def to_str(self):
        return '{} | {}'.format(self.telefone, self.endereco)
...
class Duble(Base):
    ...
    ator = relationship('Ator', backref='duble', uselist=False)
